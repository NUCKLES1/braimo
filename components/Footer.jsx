...
const Footer = () => {
    return (
        <div className='w-full h-[80vh] overflow-hidden max-sm:h-[85vh] bg-[#ebebeb]'>
            ...
            <p className='text-[#231f20] bold max-md:text-[75px] text-[13rem] max-sm:text-[115px]'>braimo</p>
            <p className='text-[#231f20] bold max-sm:mt-[-5rem] max-sm:text-[115px] max-md:text-[75px] text-[13rem]'>autos</p>
            </div>
